 ...
 * (/home/bao/.aws/credentials) where the sample code will load the credentials from.
 * <p>
...
public class S3TransferProgressSample {
    ...
    public S3TransferProgressSample() throws Exception {
        frame = new JFrame("Dropbox Clone");
        button = new JButton("Choose Directory To Watch...");
